    ...
    <main>
        ...
        <form action="Controlador/LoginUsuario.php" method="POST">
            ...
            <div class="content-imput">
                ...
                <input type="text" placeholder="Username" id="user-Login" name="usuario" required title="Este campo es obligatorio.">
            </div>
            <div class="content-imput">
                <ion-icon name="lock-closed-outline"></ion-icon>
                <input type="password" placeholder="Password" id="pass-login" name="password" required title="Este campo es obligatorio.">
            </div>
            <div class="content-check">
                <input type="checkbox" name="mantenerConectado">
                <p>Mantenerme conectado</p>
            </div>
            <button type="submit" class="btn-form" id="btn-form-login">Ingresar</button>
            <a href="Vistas/Registro.php">Ir a registro</a>
        </form>
        </div>
    </main>
...
main{
    width: 100vw;
    height: 100vh;
    background:url('Img/encabezado1.jpeg');
