...
<body>
    <main>
        <form class="Menu-User">
            <h1>DATOS DE USUARIO</h1>
            <div class="Perfil-vista">
                <img id="img-User" src="./Img/Encabezado2.PNG" alt="">
            ...
            <a href="./EditorPage.html" class="btn-user"><ion-icon name="pencil-outline"></ion-icon>Editar Datos</a>
        </form>
        <form class="Vista-Datos">
            <div class="volver">
            ...
            <div class="section-1">
                ...
                <div class="ou-datosI">
                    <p>Tipo: </p>
                    <p id="id-TipoM">No tiene datos</p>
                </div>
                <div class="ou-datosI">
                    <p>Descripción: </p>
                    <p id="des-Mem"> No Tiene Datos</p>
                </div>
                <div class="ou-datosI">
                    <p>Fecha de Compra: </p>
                    <p id="date-compra">No tiene datos</p>
                </div>
                <div class="ou-datosI">
                    <p>Costo Total: </p>
                    <p id="costo-mem">No tiene datos</p>
                </div>
            ...
            <div class="section-2">
                ...
                <div  class="ou-datosI">
                    ...
                    <p id="nombre-Entrenador">No tiene datos</p>
                </div>
                <div  class="ou-datosI">
                    <p>Fecha de contrato: </p>
                    <p id="date-contrato">No tiene datos</p>
                </div>
                <div  class="ou-datosI">
                    <p>Meses de contrato: </p>
                    <p id="mes-contrato">No tiene datos</p>
                </div>
            </div>
        <form/>
    </main>
